...
# Handle cache location & compinit
ZSH_COMPDUMP="$HOME/.cache/zsh/.zcompcache"
[[ -d $ZSH_COMPDUMP ]] || mkdir -p $ZSH_COMPDUMP # create if doesn't exist

autoload -U compinit; compinit -d "$ZSH_COMPDUMP/.zcompdump"
...
zstyle ':completion:*' cache-path "$ZSH_COMPDUMP" # not sure if this does anything
